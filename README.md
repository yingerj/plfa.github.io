...
[Here's a diff showing all my changes since I forked.](https://github.com/yingerj/plfa.github.io/compare/dev...my_progress) Note that PLFA is a moving target so I've rebased at least once to keep up, hence commit timestamps no long correspond to when I actually worked trough the exercises.

My textual additions are "notes to self" to aid me in thinking things throug, and as a result haven't been edited.


# Original PLFA README.md follows...
